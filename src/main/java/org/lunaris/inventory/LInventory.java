...
import org.lunaris.network_old.protocol.packet.Packet32InventorySlot;
 ...
 */
public abstract class LInventory implements Inventory {
    ...
    LInventory(InventoryType type) {
        this(type, null);
    }

    LInventory(InventoryType type, String title) {
