...
public class NBTOutputStream implements DataOutput, AutoCloseable {
    ...
    public void writeUTF(String s) throws IOException {
        ...
        if (network) {
            writeUnsignedVarInt(stream, bytes.length);
        } else {
    ...
    private void writeVarInt(OutputStream stream, int v) throws IOException {
