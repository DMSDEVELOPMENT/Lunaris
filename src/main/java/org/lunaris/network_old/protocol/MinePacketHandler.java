package org.lunaris.network_old.protocol;
...
import org.lunaris.network_old.protocol.packet.Packet02PlayStatus;
...
public class MinePacketHandler {
    ...
    public void handle(Packet01Login packet) {
        ...
        if(player.getProtocolVersion() != NetworkManager.SUPPORTED_CLIENT_PROTOCOL_VERSION) {
            if(player.getProtocolVersion() < NetworkManager.SUPPORTED_CLIENT_PROTOCOL_VERSION) {
//                player.sendPacketImmediately(new Packet02PlayStatus(Packet02PlayStatus.Status.LOGIN_FAILED_CLIENT));
                player.disconnect("Your client is outdated\nWe support version " + this.server.getSupportedClientVersion());
            }else {
//                player.sendPacketImmediately(new Packet02PlayStatus(Packet02PlayStatus.Status.LOGIN_FAILED_SERVER));
